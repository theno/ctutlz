...
from ctutlz.sct.verification import verify_signature_CLUNKY, verify_signature


def test_verify_signature_clunky():
    ...
    got_verified, got_output, got_cmd_res = \
        verify_signature_CLUNKY(signature_input, signature, pubkey)
