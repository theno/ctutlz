...
Datetime: 2017-08-29 23:31:42.743320
...
* __chrome bug__: `https://crbug.com/632753`
...
* __contact__: `google-ct-logs@googlegroups.com`
* __chrome bug__: `https://crbug.com/389511`
* __chrome state__: `included`
* __scts accepted by chrome__: True
...
* __contact__: `google-ct-logs@googlegroups.com`
* __chrome bug__: `https://crbug.com/431057`
* __chrome state__: `included`
* __scts accepted by chrome__: True
...
* __contact__: `google-ct-logs@googlegroups.com`
* __chrome bug__: `https://crbug.com/632752`
* __chrome state__: `included`
* __scts accepted by chrome__: True
...
* __contact__: `ctops@digicert.com`
* __chrome bug__: `https://crbug.com/419255`
* __chrome state__: `included`
* __scts accepted by chrome__: True
...
* __contact__: `ctops@digicert.com`
* __chrome bug__: `https://crbug.com/698094`
...
* __contact__: `DL-ENG-Symantec-CT-Log@symantec.com`
* __chrome bug__: `https://crbug.com/483625`
* __chrome state__: `included`
* __scts accepted by chrome__: True
...
* __contact__: `DL-ENG-Symantec-VEGA-CT-Log@symantec.com`
* __chrome state__: `included`
* __scts accepted by chrome__: True
...
* __contact__: `DL-ENG-Symantec-SIRIUS-CT-Log@symantec.com`
* __chrome bug__: `https://crbug.com/692782`
* __notes__: `Included in Chrome since M-60`
* __chrome state__: `included`
* __scts accepted by chrome__: True
...
* __chrome bug__: `https://crbug.com/605415`
* __notes__: `Included in Chrome since M-54`
* __chrome state__: `included`
* __scts accepted by chrome__: True
...
* __chrome bug__: `https://crbug.com/688510`
* __chrome state__: `included`
* __scts accepted by chrome__: True
...
* __contact__: `ctlog-admin@cnnic.cn`
* __chrome bug__: `https://crbug.com/583208`
* __chrome state__: `included`
* __scts accepted by chrome__: True
...
* __contact__: `ct@startssl.com`
* __chrome bug__: `https://crbug.com/611672`
* __chrome state__: `included`
* __scts accepted by chrome__: True
...
## frozen logs (log_list.json, webpage)
...
## UNLISTED ON WEBPAGE (log_list.json)
...
* __operated by__: `Google`
* __contact__: `google-ct-logs@googlegroups.com`
* __chrome bug__: `https://crbug.com/756813`
...
* __operated by__: `Google`
* __contact__: `google-ct-logs@googlegroups.com`
* __chrome bug__: `https://crbug.com/756814`
...
* __operated by__: `Google`
* __contact__: `google-ct-logs@googlegroups.com`
* __chrome bug__: `https://crbug.com/756817`
...
* __operated by__: `Google`
* __contact__: `google-ct-logs@googlegroups.com`
* __chrome bug__: `https://crbug.com/756818`
...
* __operated by__: `Google`
* __contact__: `google-ct-logs@googlegroups.com`
* __chrome bug__: `https://crbug.com/756819`
...
* __maximum merge delay__: `86400`
* __operated by__: `Izenpe`
* __contact__: `atecnica@izenpe.eus`
* __chrome bug__: `https://crbug.com/614323`
...
* __operated by__: `WoSign`
* __contact__: `ctlog@wosign.com`
* __chrome bug__: `https://crbug.com/534745`
* __chrome state__: `rejected`
* __scts accepted by chrome__: False
...
* __contact__: `capoc@gdca.com.cn`
* __chrome bug__: `https://crbug.com/598526`
* __chrome state__: `rejected`
* __scts accepted by chrome__: False
...
* __contact__: `capoc@gdca.com.cn`
* __chrome bug__: `https://crbug.com/654306`
* __chrome state__: `rejected`
* __scts accepted by chrome__: False
...
* __contact__: `ct-help@akamai.com`
* __chrome bug__: `http://crbug.com/447603`
* __chrome state__: `rejected`
* __scts accepted by chrome__: False
...
* __contact__: `ops@ctlogs.org`
* __chrome bug__: `http://crbug.com/403190`
* __chrome state__: `rejected`
* __scts accepted by chrome__: False
...
## distrusted logs (webpage, all_logs.json)
...
* __contact__: `certificatetransparency@outlook.com`
* __chrome bug__: `https://crbug.com/667663`
* __notes__: `Included in Chrome since M-58`
* __chrome state__: `distrusted`
* __scts accepted by chrome__: False
...
## other logs (webpage, all_logs.json)
...
* __operated by__: `Google`
* __contact__: `google-ct-logs@googlegroups.com`
* __notes__: `Note that this log is not trusted by Chrome. It only logs certificates that chain to roots that are on track for inclusion in browser roots or were trusted at some previous point. See the announcement blog post.`
...
* __operated by__: `Google`
* __contact__: `google-ct-logs@googlegroups.com`
* __notes__: `Note that this log is not trusted by Chrome. It only logs certificates that have expired. See the announcement post.`
* __scts accepted by chrome__: None
...
* __contact__: `roland@letsencrypt.org`
* __scts accepted by chrome__: None
...
* __contact__: `filippo@cloudflare.com`
* __scts accepted by chrome__: None
...
## UNLISTED ON WEBPAGE (all_logs.json)
