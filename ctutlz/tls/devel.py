...
def create_context():
    ...
    # ctx.tls_extension_18s = []

    # def tls_ext_callback(connection, tls_ext_data, data):
    #     ctx.tls_extension_18s.append(tls_ext_data)
    ...
    # ctx.set_info_callback(tls_ext_callback)
...
def devel_tls_extension_18():
    cert_x509, chainx509s, ocsp_resp_der, tls_resp_der = do_handshake(
                                                                    'ritter.vg')
    pprint(tls_resp_der)
